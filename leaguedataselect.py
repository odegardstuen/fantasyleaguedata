...
p1 = figure(y_range=[], plot_height=700,toolbar_location=None,tools=[HoverTool(), TapTool()], tooltips='GW $name: @$name')
p1.hbar_stack(gameweeks, y='Team', height=0.9,color=colors, source=source1, legend=["GW %s" % x for x in gameweeks])
...
p2 = figure(y_range=[], plot_height=100,toolbar_location=None,tools='hover', tooltips='$name: @$name')
p2.hbar_stack(teamcost, y='Team', height=0.9, source=source2, color = colors2)
